...
| `LEMON_SQUEEZY_VARIANT_ID` | ja fuer Checkout | Basis-Variant-ID, wird fuer alle Plaene verwendet wenn die spezifischen `_SINGLE`/`_FAMILY_5`/`_BENEFIT_10`-Werte fehlen | Die numerische Variant-ID aus dem Lemon-Squeezy-Dashboard; keine hartkodierten Fallbacks mehr im Code |
